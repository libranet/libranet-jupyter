...
c = get_config()  # noqa: [name-defined]
...
#  Default: '/opt/projects/libranet-jupyter/etc/lab/user-settings'
# c.LabApp.user_settings_dir = '/opt/projects/libranet-jupyter/etc/lab/user-settings'
...
#  Default: '/opt/projects/libranet-jupyter/var/run'
# c.LabApp.workspaces_dir = '/opt/projects/libranet-jupyter/var/run'
