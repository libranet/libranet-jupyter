...
#  Default: '/opt/ek/envs/ek-jupyter/etc/lab/user-settings'
# c.LabApp.user_settings_dir = '/opt/ek/envs/ek-jupyter/etc/lab/user-settings'
...
#  Default: '/opt/ek/envs/ek-jupyter/etc/lab/workspaces'
# c.LabApp.workspaces_dir = '/opt/ek/envs/ek-jupyter/etc/lab/workspaces'
...
# note WVH
# relative to $CWD
# c.ServerApp.preferred_dir = "/opt/ek/envs/ek-jupyter/var/tmp"
# c.ServerApp.preferred_dir = "var2"
# c.ServerApp.preferred_dir = "/opt/ek/envs/ek-jupyter/var/notebooks"
...
c.ServerApp.root_dir = str(base_dir / "var" / "notebooks")

import os
notebooks_dir = os.getenv("NOTEBOOKS_DIR", "")
c.ServerApp.root_dir = notebooks_dir  # str(base_dir / "var" / "notebooks")


# c.ServerApp.notebook_dir = str(base_dir / "var" / "notebooks")
